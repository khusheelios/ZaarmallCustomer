...
class BookStoreproductCategoryTypeVc: UIViewController,UICollectionViewDataSource, UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UITableViewDelegate,UITableViewDataSource {

    @IBOutlet weak var collectionView: UICollectionView!
    
    @IBOutlet weak var SelectCategoryPopup: CustomizableView!
    ...
    @IBOutlet weak var productTypePopUpView: UIView!
    ...
    var getStrChildSubCategoryId = String()
...
//        SelectCategoryPopup.isHidden = true
//    }
    ...
    @IBAction func btnSelectSubCategory(_ sender: Any) {
        ...
        userSubCategory = selectSubCategoryText.text!.trimmingCharacters(in: CharacterSet.whitespacesAndNewlines)
        
        userChildCategory = selectchildSubCategoryText.text!.trimmingCharacters(in: CharacterSet.whitespacesAndNewlines)
        if((userSubCategory.isEmpty)
            || (userChildCategory.isEmpty))
        {

         if (userSubCategory.isEmpty) {
            
            displayMyAlertMessage(userMessage: "Please Slect SubCategory")

        }
         else if(userChildCategory.isEmpty){
            displayMyAlertMessage(userMessage: "Please Slect ChildCategory")
        ...
        let storyBoard : UIStoryboard = UIStoryboard(name: "bookStore", bundle:nil)
           let nextViewController = storyBoard.instantiateViewController(withIdentifier: "BookStoreAddProductVc") as! BookStoreAddProductVc
            nextViewController.getStrproductCategoryId1 = self.getStrproductCategoryId
            nextViewController.getStrSubCategoryId1 = self.getStrSubCategoryId

            nextViewController.getStrChildSubCategoryId1 = self.getStrChildSubCategoryId
    ...
    @IBAction func btnSelect(_ sender: Any) {
        if(productTypePopUpView.isHidden == true){
            SelectCategoryPopup.isHidden = true
            productTypePopUpView.isHidden = false
            productTypePopUpView.backgroundColor = UIColor.black.withAlphaComponent(0.50)
    ...
    func setupDataSrource() {
        for (index, menuItem) in self.menuList.enumerated() {
            if index == 0 {
                let menuObject = ProductType1(withTitle: menuItem, id: menuItem, is_active: menuItem, is_delete: menuItem, create_date: menuItem, image: menuItem, isSelected: true)
                self.userArray.append(menuObject)
            } else {
                let menuObject = ProductType1(withTitle: menuItem, id: menuItem, is_active: menuItem, is_delete: menuItem, create_date: menuItem, image: menuItem, isSelected: false)
                self.userArray.append(menuObject)
            }
        }
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ProductTypeCategoryCVC", for: indexPath) as? ProductTypeCategoryCVC
        ...
        collectionView.reloadData()
                ...
                func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
                    ...
                    count = SubcategoryArray.count
                        ...
                        count = ChildCategoryNameArray.count
                ...
                func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
                    ...
                    cell.productChildcategorylbl.text = ChildCategoryNameArray[indexPath.row]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if tableView == self.tableView {
            ...
            print(self.getStrSubCategoryId)
            ...
            tableView.reloadData()
                ...
                //ChildcategoryArray
            self.getStrChildSubCategoryId = ChildCategoryIdArray[indexPath.row]
            
            let   selectedData = ChildCategoryNameArray[indexPath.row]
                                          ...
                                          //   var message = (result as AnyObject).value(forKey: "message") as! NSDictionary
                                            ...
                                            if (status == 200 as CFBoolean )
                                            {
                                                  ...
                                                  for user in data
                                                  {
                                                    ...
                                                    self.userArray.append(ProductType1(withTitle: self.productCategoryName,id: self.productCategoryId, is_active: self.productisisactiveCategory, is_delete: self.productisdeleteCategory, create_date: self.productcreateddateCategory, image: self.productimageCategory, isSelected: false))
        ...
        func getSubCategory(){
            //userSubCategory
                    ...
                    let parametersBal: Parameters=[
                        "category_id":self.getStrproductCategoryId
                        ]
                                            ...
                                            if (status == 200 as CFBoolean )
                                            {
                                                ...
                                                print("hiiii")
                                                  for user in data
                                                  {
                                                    ...
                                                    self.ChildCategoryIdArray.append(self.getChildCategoryId)
