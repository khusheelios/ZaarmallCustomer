//
//  BookStoreForgateOTpVerificationVc.swift
//  EBookApp
//
...
class BookStoreForgateOTpVerificationVc: UIViewController {
    ...
    var usercreated_dateArray = [String]()
        ...
        override func viewDidLoad() {
            ...
            strThirddigit = (Int(StrOTPNumber) % 10000)/1000
            OTPOneText.placeholder = String(strThirddigit)

            
            strfourdigit = (Int(StrOTPNumber) % 1000)/100
            OTPTwoText.placeholder = String(strfourdigit)

            
            strfivedigit = (Int(StrOTPNumber) % 100)/10
            OTPThreeText.placeholder = String(strfivedigit)

            
            strSixdigit = Int(StrOTPNumber) % 10
           ...
           // getVerifyOTP()
            ...
            func getVerifyOTP(){
                ...
                let parametersBal: Parameters=[
                    "phone":self.StrUserMobilNumber,
                    "otp":self.StrOTPNumber
                ...
                print(parametersBal)
                                ...
                                Alamofire.request("http://laxmi1963.com/ZaarMall/bookStore_match_otp", method: .post, parameters: parametersBal).responseJSON
                                    {
                                        response in
                                            ...
                                            if (status == 200 as CFBoolean )
                                            {
                                                ...
                                                for user in otpdata
                                                {
                                                   ...
                                                   // self.userProfile_pic = (user as AnyObject).value(forKey: "profile_pic") as! String
                                                    ...
                                                    self.userbook_store_name = (user as AnyObject).value(forKey: "book_store_name") as! String
                                                    ...
                                                    self.userbook_language = (user as AnyObject).value(forKey: "book_language") as! String
