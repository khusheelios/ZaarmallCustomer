...
class BookStoreMainCategoryVc: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
         ...
         let cell = tableView.dequeueReusableCell(withIdentifier: "BookStoreMainCategoryCVC", for: indexPath) as!BookStoreMainCategoryCVC
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
       ...
       DispatchQueue.main.async {
           ...
           self.SelectedStrCatrgoryName = self.CategoryNameArray[indexPath.row]
                        ...
                        let nextViewController = storyBoard.instantiateViewController(withIdentifier: "BookStoreCategoryByProductVc") as! BookStoreCategoryByProductVc
