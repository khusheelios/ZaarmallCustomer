...
class BookStorePlanVc: UIViewController {

    
    @IBOutlet weak var btnMonth: CustomizableButton!
    @IBOutlet weak var btnannunnal: CustomizableButton!
...
//
        ...
        slideshow.addSubview(label3)
                ...
                //label11.font = UIFont.systemFont(ofSize: 15.0)
        ...
        //
                ...
                //label12.font = UIFont.systemFont(ofSize: 25)
    ...
    //        self.present(nextViewController, animated:true, completion:nil)
        ...
        @IBAction func btnMonthly(_ sender: Any) {
                        ...
                        btnannunnal.backgroundColor = .clear
                        btnMonth.backgroundColor = UIColor(red: 255/255.0, green: 204/255.0, blue: 0/255.0, alpha: 1.0)

            
                        btnMonth.setTitleColor(UIColor.white, for: .normal)
                        btnannunnal.setTitleColor(UIColor.black, for: .normal)
            ...
            btnMonth.layer.cornerRadius = 20
            btnMonth.layer.borderWidth = 1
            var red = UIColor(red: 255/255.0, green: 204/255.0, blue: 0/255.0, alpha: 1.0)
            btnMonth.layer.borderColor = red.cgColor



            btnannunnal.layer.cornerRadius = 20
            btnannunnal.layer.borderWidth = 1
            var red1 = UIColor(red: 28/255.0, green: 137/255.0, blue: 197/255.0, alpha: 1.0)
            btnannunnal.layer.borderColor = red1.cgColor
        ...
        @IBAction func btnAnnunal(_ sender: Any) {
            if(mainView.isHidden == true){
                mainView.isHidden = false
                headerView.isHidden = true

            btnannunnal.backgroundColor = UIColor(red: 255/255.0, green: 204/255.0, blue: 0/255.0, alpha: 1.0)
